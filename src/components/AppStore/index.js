...
class AppStore extends Component {
  ...
  render() {
    ...
    const searchedFilterResults = filteredAppList.filter(eachApp =>
      eachApp.appName.toLowerCase().includes(searchInputVal),
    )
      ...
      <div className="app-list-container">
        ...
        <div className="search-box-container">
          <input
            ...
            placeholder="Search"
            onChange={this.getSearchElement}
          />
          <img
        ...
        <ul className="apps-container">
          {searchedFilterResults.map(eachApp => (
